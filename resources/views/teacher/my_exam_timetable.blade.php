        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h2 style="font-size: 32px;">Class: <span style="color: blue;">{{$value['class_name']}}</span> </h2>
                      @foreach($value['exam'] as $exam)
                    <div class="card">
                        <div  style="background-color:royalblue; " class="card-header col-md-12 ">
                            <h3 style="color:white; font-weight: bold; " class="card-title">Exam Name: <b>{{$exam['exam_name']}}</b></h3>
                        </div>
                        <!-- /.card-header -->
