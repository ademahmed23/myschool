...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="https://ademahmed.000webhostapp.com/" class="nav-link">Contact Me</a>
        </li>
    </ul>
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="javascript:;" style="text-align:left" class="brand-link">
        <span class="brand-text font-weight-light" style="font-weight:bold !important; font-size:20px;">ODA-Special SMS
        </span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
        ...
        <nav class="mt-2">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
               ...
               <li class="nav-item">
                ...
                <!-- --        exam                -->
                <li class="nav-item @if(Request::segment(3) == 'examination' ||Request::segment(3)=='exam'||Request::segment(3)=='exam_schedule') menu-is-opening menu-open  @endif ">
            <a href="#" class="nav-link @if(Request::segment(3) == 'exam' || Request::segment(3) == 'exam_schedule'|| Request::segment(3) == 'marks_register') active @endif  ">
              <i class="nav-icon fas fa-table"></i>
              <p>
            Examination 
                <i class="fas fa-angle-left right"></i>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
               ...
               <li class="nav-item">
                <a href="{{ url('admin/examination/marks_register') }}" class="nav-link @if(Request::segment(3) == 'marks_register') active @endif">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Marks Register</p>
                </a>
              </li>
                ...
                <li class="nav-item">
                <a href="{{ url('teacher/marks_register') }}" class="nav-link @if(Request::segment(3) == 'marks_register') active @endif">
                  <i class="nav-icon fas fa-user"></i>
                  <p>Marks Register</p>
                </a>
              </li>
                 ...
                 <li class="nav-item">
                    <a href="{{ url('teacher/my_student') }}"
                        class="nav-link @if(Request::segment(2) == 'my_class') active @endif">
                       <i class="nav-icon fas fa-user  "></i>
                        <p>
                          My Student
                            <span class="badge badge-info right"></span>
