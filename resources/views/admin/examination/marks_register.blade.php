                                    ...
                                    $totalPassMark = $totalPassMark + $subjects->pass_mark;
                                     ...
                                     <td>
                                        ...
                                        <input style="width: 150px;" type="hidden" name="mark[{{ $i }}][subject_id]" value="{{$subjects->subject_id}}">
                                         ...
                                         value="{{!empty($getMark->test) ? $getMark->test : ''}}" id="test_{{$student->id}}{{$subjects->subject_id}}">
                                     </div>
                                     <div  margin-bottom: 10px;>
                                         Class Work
                                         <input style="width: 150px;" type="hidden" name="mark[{{$i}}][subject_id]" value="{{$subjects->subject_id}} " value="{{!empty(($getMark->class_work)? $getMark->test : '')}}" id="{{$student->id}}{{$subjects->subject_id}}">
                                     ...
                                     <div style=" margin-bottom: 10px;">
                                       Assignment
                                         <input style="width: 150px;" type="text" value="{{!empty($getMark->assignment) ? $getMark->assignment : ''}}" name="mark[{{ $i }}][assignment]"placeholder="Enter Marks" class="form-control" id="assignment_{{$student->id}}{{$subjects->subject_id}}">
                                     </div>
                                     <div style=" margin-bottom: 10px;">
                                       Home Work
                                         <input style="width: 150px;" type="text"value="{{!empty($getMark->home_work) ? $getMark->home_work : ''}}" name="mark[{{ $i }}][home_work]"placeholder="Enter Marks" class="form-control" id="home_work_{{$student->id}}{{$subjects->subject_id}}">
                                     </div>
                                     <div  style=" margin-bottom: 10px;">
                                         Mid-Exam
                                         <input style="width: 150px;" type="text" value="{{!empty($getMark->mid_exam) ? $getMark->mid_exam : ''}}" name="mark[{{ $i }}][mid_exam]" placeholder="Mid-Exam Mark" class="form-control" id="mid_exam_{{$student->id}}{{$subjects->subject_id}}">
                                     </div>
                                     <div style=" margin-bottom: 10px;">
                                         Final-Exam
                                         <input style="width: 150px;" type="text" value="{{!empty($getMark->final_exam) ? $getMark->final_exam : ''}}" name="mark[{{ $i }}][final_exam]" placeholder="final-Exam Mark"class="form-control" id="final_exam_{{$student->id}}{{$subjects->subject_id}}">
                                     </div>
                                     <div>
...
$.ajax({
type:"POST",
url: "{{url('admin/examination/submit_mark_register')}}",
data:$(this).serialize(),
dataType : "json",
...
$. ajax({
type:"POST",
url: "{{url('admin/examination/singlesubmit_mark_register')}}",
data:{
    "_token" : "{{csrf_token()}}",
    id :id,
