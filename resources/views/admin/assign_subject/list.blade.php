         ...
         <div class="container-fluid">
             <div class="row mb-2">
                 ...
                 <div class="col-sm-6" style="text-align:right">
                     <a href="{{url('admin/assign_subject/add')}}" class="btn btn-primary btn-sm">Assign new Subject </a>
                 </div>
             </div>
                             ...
                             <form method="get" method="">
                                 <div class="row m-2">
                                     ...
                                     <div class="col-md-3">
                                         ...
                                         <a href="{{route('assign_subject.list')}}" class="btn btn-success btn-sm"
                                 ...
                                 <tbody>
                                     ...
                                     <tr>
                                         ...
                                         <td style=" text-align: center">
                                             ...
                                             <a href="{{url('admin/assign_subject/single_edit/'.$value->id)}}"
