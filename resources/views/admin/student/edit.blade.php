                    ...
                    <div class="card card-primary">
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6"> <label>Admission Number<span
                                                style="color: red;">*</span></label>
                                        <input type="text" class="form-control"
                                            value="{{ old('admission_number', $getrecords->admission_number) }}"
                                    ...
                                    <div class="form-group col-md-6"> <label>Roll Number<span
                                                style="color: red;">*</span></label>
                                        <input type="text" class="form-control"
                                            value="{{ old('roll_number', $getrecords->roll_number) }}"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="class_id" class="form-control" required>
                                            ...
                                            <option
                                                {{ (old('class_id', $getrecords->class_id) == $value->id)? 'selected': '' }}
                                    ...
                                    <div class="form-group col-md-6"> <label>Admission Date<span
                                                style="color: red;">*</span></label>
                                        <input type="date" class="form-control"
                                            value="{{ old('admission_date', $getrecords->admission_date) }}" required
                                            placeholder="Admitted Date" name="admission_date">
                                        <div style="color:red">
                                    ...
                                    <div class="form-group col-md-6"> <label>Status<span
                                        ...
                                        <select class="form-control" required name="status">
                                            ...
                                            <option {{ (old('status', $getrecords->status) == 0)? 'selected' :'' }}
                                                <option value="0">Active
                                            </option>
                                            <option {{ (old('status', $getrecords->status) == 1)? 'selected' :'' }}
                                                <option value="1">
                                                Inactive</option>
                                        </select>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <p>Do you wanna change your password || Add New Password</p>
                            </div>
                    </div>
                </div>
