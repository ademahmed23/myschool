       ...
       $data['header_title'] = "Add New Teacher";
         ...
         public function insert(Request $request){
           ...
           $teacher= new User;
            ...
            $teacher-> user_type = 2;
            $teacher->save();
return redirect('admin/teacher/list')->with('success','student successfully registered ');
 ...
 if(!empty($request->admission_date)){
            ...
            if(!empty($request->file('profile_picture')))
            {
                if (!empty($teacher->getProfile())) {
                    unlink('uploads/profiles/'.$teacher-> profile_picture);
            ...
            $teacher->save();
return redirect('admin/teacher/list')->with('success','student successfully updated ');
